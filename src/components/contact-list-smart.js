...
class ContactList extends React.Component { 
	...
	render( ) { 
	 	...
	 	return <div>
	 				...
	 				<Person toggle = { this.toggleEditPerson } editing = { this.state.editingperson } save = { this.savePerson } reset = { this.resetPerson } person = { this.currentperson( ) } deletemeet = { this.deleteMeeting } />
	 			</div>
	  }
}
